...
public sealed class AppSettings
{
    ...
    public PerformanceMonitorSettings PerformanceMonitor { get; set; } = new();
}
...
public sealed class WorkerSettings
{
    ...
    [
        ...
        new() { Id = "pc-monitor", Name = "电脑监控", Description = "LHM + 管理员采集 + PDH + WMI，可选 HWiNFO 高级数据源", Port = 17322, HealthPath = "/health", AutoStart = false, BuiltIn = true },
...
public sealed record HardwareSensorSnapshot(
    ...
    int SensorCount,
    DateTimeOffset Timestamp,
    double? CpuTemperatureMaxC = null,
    double? CpuCoreAverageTemperatureC = null,
    double? CpuCoresPowerW = null,
    double? CpuVidV = null,
    double? CpuBusClockMhz = null,
    double? GpuHotspotTemperatureC = null,
    double? GpuMemoryTemperatureC = null,
    double? GpuPowerW = null,
    double? GpuVoltageV = null,
    double? GpuMemoryClockMhz = null,
    double? GpuVramUsedMb = null,
    double? GpuVramTotalMb = null,
    double? MotherboardTemperatureC = null,
    double? VrmTemperatureC = null,
    double? DiskTemperatureC = null,
    double? DiskHealthPercent = null,
    double? ChassisFanRpm = null,
    double? PumpRpm = null,
