...
pub struct SmtcStatus {
    ...
    pub ncm_id: i64,
    /// Raw position reported by the media session before clock extrapolation.
    #[serde(default)]
    pub raw_position_ms: i64,
    pub position_ms: i64,
    pub duration_ms: i64,
    /// UTC Unix timestamp associated with `raw_position_ms`.
    #[serde(default)]
    pub timeline_updated_at_ms: i64,
